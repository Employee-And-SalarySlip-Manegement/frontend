...
const AdminSidebar = ({ isCollapsed, onToggle, className = '' }) => {
  ...
  return (
    <div className={`admin-sidebar-component ${isCollapsed ? 'collapsed' : ''} ${className}`}>
      {/* Sidebar Header */}
      ...
      <div className="admin-sidebar-user">
        ...
        {!isCollapsed && (
          <div className="admin-sidebar-user-info">
            <h4 className="admin-sidebar-user-name">{user?.name || 'Admin User'}</h4>
          ...
          {menuItems.map((item) => (
            <li key={item.id} className="admin-sidebar-nav-item">
              ...
              >
                ...
                {!isCollapsed && <span className="admin-sidebar-nav-label">{item.label}</span>}
              </NavLink>
            </li>
          ))}
        </ul>
