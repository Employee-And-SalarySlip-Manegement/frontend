...
const ViewSalarySlip = () => {
  ...
  const empId = storedState?.state?.user?.empId || null;
  console.log(empId); // "EMP101"
  ...
  const { salarySlipData, loading, error } = useSalarySlip(empId, selectedMonth);
      ...
      <div className="vss-container">
        ...
        <div className="vss-header">
          ...
          <div className="vss-header-info">
            ...
            <p className="vss-subtitle">Employee ID: {empId}</p>
          </div>
        </div>
          ...
          <div className="vss-actions">
            ...
            <button
              ...
              onClick={() => {
                ...
                link.download = `SalarySlip_${empId}_${selectedMonth}.pdf`;
